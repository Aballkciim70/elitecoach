...
(() => {
  ...
  // Une seule initialisation différée suffit.
  // L’ancien MutationObserver relançait relabelAdmin() après chacune de ses
  // propres modifications de texte, créant une boucle infinie qui bloquait la page.
  window.addEventListener("kpsul:admin-ready", relabelAdmin);
})();
