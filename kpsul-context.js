...
(() => {
  ...
  function selectClient(clientId) {
    ...
    window.selectedClientId = state.selectedClientId;
  ...
  function installCss() {
    ...
    style.textContent = `
      ...
      /* Ne jamais contourner la protection de connexion existante :
         #member ne devient visible que lorsque le noyau ajoute body.authed. */
      body.authed[data-kpsul-workspace="client"] ${CLIENT_ROOT}{
        display:block!important;
        visibility:visible!important;
      }

      /* L'administration ne devient visible qu'après validation du rôle
         et bascule explicite du contexte. */
      body.authed[data-kpsul-workspace="admin"] ${ADMIN_ROOT}{
        display:block!important;
        visibility:visible!important;
      }

      body:not(.authed) ${CLIENT_ROOT},
      body:not(.authed) ${ADMIN_ROOT}{
        display:none!important;
      }
